...
> ## ✅ הוקם — המסמך הזה הוא היסטוריה
>
> הענן חי מ-22/07/2026. הפרויקט: `shichzurim` (פרנקפורט), הקונפיג מלא
> ב-`assets/cloud.js`, ו-`REQUIRE_LOGIN` דלוק. אין צורך לעבור על הצעדים כאן
> שוב — הם נשמרים כתיעוד של איך זה הוקם, ולמקרה של הקמה מחדש.
>
> **מה שכן מתחזקים שוטף: `supabase/MIGRATIONS-RUN.md`** — הרשימה של אילו
> מיגרציות כבר הורצו במסד. המסמך הזה מזכיר רק את `0001`, ומאז נוספו שבע.
