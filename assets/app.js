...
function tourSteps() {
  ...
  return [
    ...
    { route: '#/', center: true,
      title: '🔑 קודם כול — התחבר',
      body: 'נכנסים עם חשבון Google מהכפתור למעלה. זה חינם, וזה נותן דבר אחד חשוב: ' +
            'ההתקדמות שלך נשמרת בחשבון וממשיכה מכל מכשיר — טלפון, מחשב, ספרייה. ' +
            'רק אתה רואה אותה. אפשר גם להסתובב בלי להתחבר, אבל אז ההתקדמות נשמרת רק בדפדפן הזה.' },
