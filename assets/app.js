  ...
  function questionCard(item, qi) {
    ...
    if (r && r.conflict)
      card.append(
        r.resolved
          ? el('div', 'q-warn ok',
              '✅ המחזורים סימנו תשובות שונות בשאלה הזאת, והיא הוכרעה מול חומרי הקורס. ' +
              'המפתח כאן מתוקן — ההסבר בהערה שמתחת.')
          : el('div', 'q-warn',
              '⚠️ המחזורים חלוקים על התשובה הנכונה, וטרם הוכרע מי צודק. אל תשנן את השאלה הזאת — תבין אותה.')
      );
